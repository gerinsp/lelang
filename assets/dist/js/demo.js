...
function tampildetailcustomer(elem, e) {
  e.preventDefault();
  const idcustomer = $(elem).data("idcustomer");
  const namacustomer = $(elem).data("namacustomer");
  const jeniskelamincustomer = $(elem).data("jeniskelamincustomer");
  const alamatcustomer = $(elem).data("alamatcustomer");
  const nohpcustomer = $(elem).data("nohpcustomer");
  const nikcustomer = $(elem).data("nikcustomer");
  $("#nikcustomer").attr("value", nikcustomer);
  $("#namacustomer").attr("value", namacustomer);
  $("#jeniskelamincustomer").attr("value", jeniskelamincustomer);
