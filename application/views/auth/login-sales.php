<body class="hold-transition login-page">
   <div class="login-box">
      ...
      <div class="login-box-body" style="border-radius: 6px">
          <h3 style="margin-bottom: 30px;font-size: 2.3rem;margin-top: 0"><b>Form Login Sales</b></h3>
         <?= $this->session->flashdata('message'); ?>
         <form method="post" action="<?= base_url('login/sales') ?>">
            ...
            <div class="row">
               ...
               <!-- /.col -->
               <div class="col-xs-4">
                  <button style="border-radius: 6px" type="submit" class="btn btn-warning btn-block btn-flat">Login</button>
               </div>
               <!-- /.col -->
            </div>
         </form>
