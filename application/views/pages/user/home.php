    ...
    <div class="max-w-screen-xl mx-auto px-4 my-4">
        <div class="flex items-center justify-between">
            ...
            <div class="arrow-category">
                <svg class="hover-pointer" onclick="scrollToLeft('scrollableElementKategori')" xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" viewBox="0 0 24 24"><path class="fill-svg" fill="none" stroke="#256fd0" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m5 12l6-6m-6 6l6 6m-6-6h14"/></svg>
                <svg class="hover-pointer" onclick="scrollToRight('scrollableElementKategori')" xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" viewBox="0 0 24 24"><path class="fill-svg" fill="none" stroke="#256fd0" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 12l-6-6m6 6l-6 6m6-6H5"/></svg>
            </div>
        </div>
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="arrow-category">
                <svg class="hover-pointer" onclick="scrollToLeft('scrollableElementLive')" xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" viewBox="0 0 24 24"><path class="fill-svg" fill="none" stroke="#256fd0" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m5 12l6-6m-6 6l6 6m-6-6h14"/></svg>
                <svg class="hover-pointer" onclick="scrollToRight('scrollableElementLive')" xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" viewBox="0 0 24 24"><path class="fill-svg" fill="none" stroke="#256fd0" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 12l-6-6m6 6l-6 6m6-6H5"/></svg>
            </div>
        </div>
