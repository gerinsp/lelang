                          ...
                          <div class="row">
                              <div class="col-md-12">
                                  <div class="form-group">
                                      ...
                                      <input onchange="previewImage(this, '4')"  required accept="image/jpeg, image/jpg, image/png" type="file" name="gambar4" id="gambar4" class="form-control" style="height: 45px;" placeholder="" aria-describedby="helpId">
                                  </div>
                              </div>
                          </div>
                      </div>
                          ...
                          <div class="row">
                              <div class="col-md-12">
                                  <div class="form-group">
                                      ...
                                      <input onchange="previewImage(this, '5')"  required accept="image/jpeg, image/jpg, image/png" type="file" name="gambar5" id="gambar5" class="form-control" style="height: 45px;" placeholder="" aria-describedby="helpId">
                                  </div>
                              </div>
                          </div>
                          <div class="row">
                              <div class="col-md-12">
                                  <div class="form-group">
                                      ...
                                      <input onchange="previewImage(this, '6')"  required accept="image/jpeg, image/jpg, image/png" type="file" name="gambar6" id="gambar6" class="form-control" style="height: 45px;" placeholder="" aria-describedby="helpId">
                                  </div>
                              </div>
                          </div>
                          <div class="row">
                              <div class="col-md-12">
                                  <div class="form-group">
                                      ...
                                      <input onchange="previewImage(this, '7')"  required accept="image/jpeg, image/jpg, image/png" type="file" name="gambar7" id="gambar7" class="form-control" style="height: 45px;" placeholder="" aria-describedby="helpId">
                                  </div>
                              </div>
                          </div>
                          <div class="row">
                              <div class="col-md-12">
                                  <div class="form-group">
                                      ...
                                      <input onchange="previewImage(this, '8')"  required accept="image/jpeg, image/jpg, image/png" type="file" name="gambar8" id="gambar8" class="form-control" style="height: 45px;" placeholder="" aria-describedby="helpId">
                                  </div>
                              </div>
                          </div>
                      </div>
                          ...
                          <div class="row">
                              <div class="col-md-12">
                                  <div class="form-group">
                                      ...
                                      <input onchange="previewImage(this, '9')"  required accept="image/jpeg, image/jpg, image/png" type="file" name="gambar9" id="gambar9" class="form-control" style="height: 45px;" placeholder="" aria-describedby="helpId">
                                  </div>
                              </div>
                          </div>
                          <div class="row">
                              <div class="col-md-12">
                                  <div class="form-group">
                                      ...
                                      <input onchange="previewImage(this, '10')" required accept="image/jpeg, image/jpg, image/png" type="file" name="gambar10" id="gambar10" class="form-control" style="height: 45px;" placeholder="" aria-describedby="helpId">
                                  </div>
                              </div>
                          </div>
                          <div class="row">
                              <div class="col-md-12">
                                  <div class="form-group">
                                      ...
                                      <input onchange="previewImage(this, '11')" required accept="image/jpeg, image/jpg, image/png" type="file" name="gambar11" id="gambar11" class="form-control" style="height: 45px;" placeholder="" aria-describedby="helpId">
                                  </div>
                              </div>
                          </div>
                          <div class="row">
                              <div class="col-md-12">
                                  <div class="form-group">
                                      ...
                                      <input onchange="previewImage(this, '12')" required accept="image/jpeg, image/jpg, image/png" type="file" name="gambar12" id="gambar12" class="form-control" style="height: 45px;" placeholder="" aria-describedby="helpId">
                                  </div>
                              </div>
                          </div>
                      </div>
